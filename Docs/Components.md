...
the instance lives in (Bootstrap for engine-lifetime singletons, Scene for
per-scene components, and so on, from [Core's scopes](Core.md#allocators-and-scope)):
